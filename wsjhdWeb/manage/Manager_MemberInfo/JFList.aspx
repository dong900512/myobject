<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JFList.aspx.cs" Inherits="NewInfoWeb.manage.Manager_MemberInfo.JFList" %>
    ...
    <div class="itempage">
        <div class="search_total" style="height: 140px">
            ...
            <div class="itme_input">
                ...
                <a class="add_user" href="AllMember.aspx" style="cursor: pointer">返回</a>
                <br class="clear_both" />
            </div>
            <div class="btnall">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="width: 16%">
                                    <a style="color: black;" href="JFList.aspx?del=<%#Eval("Id") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>&topid=<%=topid %>"
                ...
                <ul>
                    <li class="list_li_page"><span style="float: left; margin-top: 20px; display: none;">
                        ...
                        <webdiyer:AspNetPager ID="AspNetPager1" ShowCustomInfoSection="Left" Visible="true"
                            ...
                            ShowBoxThreshold="10" PageSize="5" CssClass="pagination" LayoutType="Ul" PagingButtonLayoutType="UnorderedList"
