<%@ Page Title="" Language="C#" MasterPageFile="~/manage/SphereActivity/Activity.master"
    AutoEventWireup="true" CodeBehind="ActivityEdit.aspx.cs" Inherits="NewInfoWeb.manage.SphereActivity.ActivityEdit"
    ...
    <table class="table" cellpadding="4" cellspacing="1">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtStart" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'%y-%M-%d}'})"
