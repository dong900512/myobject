<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="infoadd.aspx.cs" Inherits="NewInfoWeb.manage.Manager_al.infoadd" %>
...
<head>
    ...
    <script>
        ...
        KindEditor.ready(function (K) {
            window.editor = K.create('#txtcontent,#txtsummary', {
                uploadJson: '/manage/kindeditor-4.1.10/asp.net/upload_json.ashx',
...
<body>
    <form id="form1" runat="server">
        <div class="add_border">
            <div class="add_txt">
                <span><%=currtitle %> 案例信息操作</span>
            </div>
            <div>
                <div class="add_infor">
                    <ul>
                        <li class="infor_txt">标题：&nbsp;<font style="color: red">*</font></li>
                        <li>
                            <div class="infot_input">
                                <asp:TextBox ID="txttitle" runat="server" CssClass="input_txt"></asp:TextBox>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="add_infor">
                    <ul>
                        <li class="infor_txt">描述信息：&nbsp;<font style="color: red">*</font></li>
                        <li>
                            <div class="infot_input">
                                <asp:TextBox ID="txtdesc" runat="server" Height="80px" TextMode="MultiLine" Width="300px" MaxLength="100"></asp:TextBox>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="add_infor" style="margin-top:130px;">
                    <ul>
                        <li class="infor_txt">跳转链接：&nbsp;<font style="color: red">*</font></li>
                        <li>
                            <div class="infot_input">
                                <asp:TextBox ID="txttzinfo" runat="server" CssClass="input_txt"></asp:TextBox>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="add_infor" id="slt" runat="server" visible="false" style="padding-bottom: 240px; padding-top: 5px;">
                    <ul>
                        ...
                        <li>
                            <div class="infot_input">
                                <input id="upfile" runat="server" onchange="return confirmsuffix(this)" type="file" /><font
                                    color="red"><asp:HyperLink runat="server" ID="hyp" Visible="false" Target="_blank" />(300*150像素)
                                </font>
                            </div>
                        </li>
                    </ul>
