<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bannerlist.aspx.cs" Inherits="NewInfoWeb.manage.Manager_al.bannerlist" %>

<!DOCTYPE html >
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>案例Banner列表</title>
        ...
        <div class="itempage">
            <div class="search_total" style="height: 140px">
                ...
                <div class="itme_input">
                    ...
                    <a class="add_user" href="banneradd.aspx" style="cursor: pointer">添加信息</a>
                    <br class="clear_both" />
                </div>
                <div class="btnall">
                ...
                <div class="list_item_txt">
                    <table style="width: 100%">
                        <asp:Repeater ID="rptLoop" runat="server">
                            <HeaderTemplate>
                                <tr>
                                    <th class="list_li_txt1" style="width: 6%">编号
                                    </th>
                                    <th class="list_li_txt2" style="width: 25%">标题
                                    </th>
                                    <th class="list_li_txt2" style="width: 40%">Banner缩略图
                                    </th>
                                    <th class="list_li_txt2" style="width: 20%">操作
                                    </th>
                                </tr>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="list_li_txt3" style="width: 40%">
                                        <img src='<%#globalVariables.NewsImgServer + Eval("Income")%>' />
                                    </td>
                                    <td class="list_li_txt3" style="width: 20%">
                                        <a href="banneradd.aspx?id=<%#Eval("Id") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit"
                                            style="color: black;">编辑</a> <a style="color: red;" href="bannerlist.aspx?del=<%#Eval("Id") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>"
                    ...
                    <ul>
                        <li class="list_li_page"><span style="float: left; margin-top: 20px; display: none;">共
