<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="infolist.aspx.cs" Inherits="NewInfoWeb.manage.Manager_al.infolist" %>
        ...
        <div class="itempage">
            <div class="search_total" style="height: 140px">
                ...
                <div class="itme_input">
                    ...
                    <a class="add_user" href="infoadd.aspx?type=<%=ctid %>" style="cursor: pointer">添加信息</a>
                    <br class="clear_both" />
                </div>
                <div class="btnall">
                </div>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="list_li_txt3" style="width: 20%">
                                        <a href="infoadd.aspx?id=<%#Eval("Id") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit&type=<%=ctid %>"
                                            style="color: black;">编辑</a> <a style="color: red;" href="infolist.aspx?del=<%#Eval("Id") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>&type=<%=ctid %>"
