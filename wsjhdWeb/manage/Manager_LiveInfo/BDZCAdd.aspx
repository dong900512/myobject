<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDZCAdd.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDZCAdd"
...
<body>
    ...
    <div class="add_border">
        ...
        <div>
                    ...
                    <li>
                        <div class="infot_input">
                            <asp:TextBox ID="txtkeyword" runat="server" CssClass="input_txt" MaxLength="50"></asp:TextBox><font
                                color="red">请填写主要的一个联系方式(如：0898-6222 4289)若填写错误 则无法拨打</font></div>
                    </li>
                    <li class="hint_txt"></li>
                </ul>
            </div>
            <div class="add_infor" style="padding-top: 60px;">
                <ul>
            ...
            <div class="add_infor" style="padding-top: 156px;">
                <ul>
                    ...
                    <li>
                        <div class="infot_input">
                            ...
                            <asp:HiddenField ID="hidTyp" runat="server" />
                            <asp:HiddenField ID="hid1" runat="server" Value="0" />
                        </div>
                    </li>
                </ul>
            </div>
