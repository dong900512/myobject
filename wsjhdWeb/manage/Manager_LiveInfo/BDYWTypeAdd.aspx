<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDYWTypeAdd.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDYWTypeAdd" ValidateRequest="false"%>
...
<body>
    ...
    <div class="add_border">
        ...
        <div>
            ...
            <div class="add_infor">
                <ul>
                    <li class="infor_txt">类型名称：&nbsp;<font style="color: red">*</font></li>
                    <li>
                        <div class="infot_input">
            ...
            <div class="add_infor">
                <ul>
                    <li class="infor_txt">联系电话：&nbsp;<font style="color: red">*</font></li>
                    <li>
                        <div class="infot_input">
                    ...
                    <li>
                        <div class="infot_input">
                            <input id="upfile" runat="server" onchange="return confirmsuffix(this)" type="file" /><font
                                color="red"><asp:HyperLink runat="server" ID="hyp" Visible=false  Target="_blank"/>(600*180)
                    </font></div>
                    </li>
                </ul>
            </div>
            <div class="add_infor">
                <ul>
                    <li class="infor_txt">类别描述：&nbsp;<font style="color: red"></font></li>
                    <li>
                        <div class="infot_input">
            ...
            <div class="add_infor"  style="padding-top:150px;">
                <ul>
