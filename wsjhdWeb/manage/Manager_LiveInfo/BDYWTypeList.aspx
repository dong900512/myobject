<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDYWTypeList.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDYWTypeList" %>

<!DOCTYPE html >
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>半岛游玩类型列表</title>
    ...
    <div class="itempage">
        <div class="search_total" style="height: 140px">
            ...
            <div class="itme_input">
                ...
                <a class="add_user1" href="BDYWTypeAdd.aspx" style="cursor: pointer">添加游玩类型</a>
                <br class="clear_both" />
            </div>
            <div class="btnall">
            </div>
                    ...
                    <asp:Repeater ID="rptLoop" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="cursor: hand; width: 23%" title="<%#Eval("Title")%>">
                                    <%#Eval("Title")%>
                                </td>
                                ...
                                <td class="list_li_txt3" style="width: 26%">
                                    <a href="BDYWTypeAdd.aspx?id=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit"
                                        style="color: black;">编辑</a> <a style="color: red;" href="BDYWTypeList.aspx?del=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>"
                                            onclick="return confirm('删除后将无法恢复，您确定要删除吗？');">删除</a>  <a href="BDYWList.aspx?tid=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>">查看项目信息</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
