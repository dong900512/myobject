<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDJKGL.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDJKGL"
    ...
    <div class="itempage">
        <div class="search_total">
            ...
            <div class="itme_input">
                ...
                <a class="add_user1" href="BDJKAdd.aspx" style="cursor: pointer">添加信息</a>
                <br class="clear_both" />
            </div>
            <div class="btnall">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="width: 26%">
                                    <a href="BDJKAdd.aspx?id=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit"
                                        style="color: black;">编辑</a> <a style="color: red;" href="BDJKGL.aspx?del=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>"
