<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDGAdd.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDGAdd"
    ...
    <div class="add_border">
        ...
        <div>
            ...
            <div class="add_infor" style="display: none;">
                <ul>
                    <li class="infor_txt">关键字：&nbsp;<font style="color: red"></font></li>
                    <li>
                        <div class="infot_input">
                    ...
                    <li>
                        <div class="infot_input">
                            <input id="upfile" runat="server" onchange="return confirmsuffix(this)" type="file" /><font
                                color="red"><asp:HyperLink runat="server" ID="hyp" Visible=false  Target="_blank"/>(291*221)
                    </font></div>
                    </li>
                </ul>
            </div>
            <div class="add_infor">
                <ul>
                    <li class="infor_txt">公交描述：&nbsp;<font style="color: red">*</font></li>
                    <li>
                        <div class="infot_input">
            ...
            <div class="add_infor" style="margin-top: 245px; height: 550px;">
                <ul>
                    <li class="infor_txt">公交详情信息：&nbsp;<font style="color: red">*</font></li>
                    <li>
                        <div class="infot_input" style="width: 700px; height: 490px;">
                            <textarea id="txtcontent" runat="server" cols="50" rows="5" style="width: 680px;
                                height: 540px;"></textarea></div>
                    </li>
                </ul>
            </div>
            <div class="add_infor">
