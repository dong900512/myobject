<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDMSAdd.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDMSAdd"
...
<body>
    ...
    <div class="add_border">
        ...
        <div>
            ...
            <div class="add_infor">
                <ul>
                    <li class="infor_txt">美食标题：&nbsp;<font style="color: red">*</font></li>
                    <li>
                        <div class="infot_input">
                    ...
                    <li>
                        <div class="infot_input">
                            <input id="upfile" runat="server" onchange="return confirmsuffix(this)" type="file" /><font
                                color="red"><asp:HyperLink runat="server" ID="hyp" Visible=false  Target="_blank"/>(202*152)
                    </font></div>
                    </li>
                </ul>
            </div>
            <div class="add_infor">
                <ul>
                    <li class="infor_txt">美食描述：&nbsp;<font style="color: red"></font></li>
                    <li>
                        <div class="infot_input">
            ...
            <div class="add_infor" style="margin-top: 245px; height: 650px;">
                <ul>
                    <li class="infor_txt">内容信息：&nbsp;<font style="color: red">*</font></li>
                    <li>
                        <div class="infot_input" style="width: 700px; height: 670px; overflow-y: scroll;">
                            <textarea id="txtcontent" runat="server" cols="50" rows="5" style="width: 680px;
                                height: 670px;"></textarea></div>
                    </li>
                </ul>
            </div>
            <div class="add_infor" style="display: none;">
                <ul>
                    <li class="infor_txt">状态信息：&nbsp;<font style="color: red"></font></li>
                    <li>
                        <div class="c12">
