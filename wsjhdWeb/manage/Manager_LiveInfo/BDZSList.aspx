<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDZSList.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDZSList" %>
    ...
    <div class="itempage">
        <div class="search_total">
            ...
            <div class="itme_input">
                ...
                <a class="add_user1" href="BDZSAdd.aspx?typid=<%=typid %>" style="cursor: pointer">添加信息</a>
                <a class="add_user1" href="BannerList.aspx?typid=<%=typid %>" style="cursor: pointer">
                    查看滚动Banner</a>
                <br class="clear_both" />
            </div>
            <div class="btnall">
                    ...
                    <asp:Repeater ID="rptLoop" runat="server">
                        <HeaderTemplate>
                            <tr>
                                ...
                                <th class="list_li_txt2" style="width: 33%">
                                    描述
                                </th>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="cursor: hand; width: 20%" title="<%#Eval("Title")%>">
                                    <%#Eval("Title")%>
                                </td>
                                <td class="list_li_txt3" style="width: 33%" title='<%#Eval("Description") %>'>
                                    <%#Eval("Description")%>
                                </td>
                                ...
                                <td class="list_li_txt3" style="width: 26%">
                                    <a href="BDZSAdd.aspx?id=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit&typid=<%=typid %>"
                                        style="color: black;">编辑</a> <a style="color: red;" href="BDZSList.aspx?del=<%#Eval("AritcleID") %>&tid=<%=typid %>"
