<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BMSeverList.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BMSeverList" %>
        ...
        <div class="search_total" style="height: 140px">
            ...
            <div class="itme_input">
                <div class="itme_num">
                    <dt>服务类别：</dt>
                    <dd>
                        <asp:DropDownList CssClass="select_one" ID="drptype" runat="server" Width="150">
                            <asp:ListItem Text="服务类别" Value="-1"></asp:ListItem>
                ...
                <a class="add_user" href="BMServerAdd.aspx" style="cursor: pointer">添加信息</a>
                <br class="clear_both" />
            </div>
            <div class="btnall">
                    ...
                    <asp:Repeater ID="rptLoop" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="cursor: hand; width: 15%" alt="<%#Eval("Title")%>">
                                    <%#Eval("Title")%>
                                </td>
                                ...
                                <td class="list_li_txt3" style="width: 15%">
                                    <%#Eval("Type").ToString() == "1" ? "快递服务" : (Eval("Type").ToString() == "2" ? "综合便民服务" : (Eval("Type").ToString() == "3"?"配套半岛商业":"配套半岛酒店"))%>
                                </td>
                                <td class="list_li_txt3" style="width: 15%">
                                    <%#string.Format("{0:yyyy-MM-dd}",Eval("AddTime"))%>
                                </td>
                                <td class="list_li_txt3" style="width: 26%">
                                    <a href="BMServerAdd.aspx?id=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit"
                                        style="color: black;">编辑</a> <a style="color: red;" href="BMSeverList.aspx?del=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>"
