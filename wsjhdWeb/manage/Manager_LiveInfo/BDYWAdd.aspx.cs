...
{
    public partial class BDYWAdd : ManageBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string reqStrUrl = "BDYWList.aspx?tid=" + typid;
        ...
        protected void btn_click_Click(object sender, ImageClickEventArgs e)
        {
            ...
            using (WXDBEntities db = new WXDBEntities())
            {
                ...
                if (aid != -1)
                {
                    ...
                    if (addobj != null)
                    {
                        string str = WebUtil.UpLoadImage(upfile, "/Files/NewsImg/", Guid.NewGuid().ToString().ToLower(), 290, 203);
                ...
                db.SaveChanges();
                jsHint.toUrl("信息" + addobj.Title + "操作成功!", "BDYWList.aspx?tid=" + typid);
            }
        }
    }
}