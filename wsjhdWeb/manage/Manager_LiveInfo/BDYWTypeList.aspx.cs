...
{
    public partial class BDYWTypeList : System.Web.UI.Page
    {
        ...
        private void BindRepeater()
        {
            ...
            using (WXDBEntities db = new WXDBEntities())
            {
                IQueryable<Article> carlist = db.Article.Where(s => (!s.Status.Equals(2)) && s.Type.Equals(18)).OrderBy(o => o.Orders).ThenBy(o => o.AritcleID);
