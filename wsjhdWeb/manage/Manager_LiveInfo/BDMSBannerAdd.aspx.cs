...
{
    public partial class BDMSBannerAdd : ManageBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string reqStrUrl = "BDMSBannerList.aspx?tid=" + typid;
        ...
        protected void btn_click_Click(object sender, ImageClickEventArgs e)
        {
            ...
            using (WXDBEntities db = new WXDBEntities())
            {
                ...
                db.SaveChanges();
                jsHint.toUrl("信息" + addobj.Title + "操作成功!", "BDMSBannerList.aspx?tid=" + hidtype.Value);
            }
        }
    }
}