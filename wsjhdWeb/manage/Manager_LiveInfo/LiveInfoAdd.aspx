<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiveInfoAdd.aspx.cs" ValidateRequest="false"
    Inherits="NewInfoWeb.manage.Manager_LiveInfo.LiveInfoAdd" %>
...
<body>
    ...
    <div class="add_border">
        ...
        <div>
            ...
            <div class="add_infor">
                <ul>
                    <li class="infor_txt">信息标题：&nbsp;<font style="color: red">*</font></li>
                    <li>
                        <div class="infot_input">
            ...
            <div class="add_infor">
                <ul>
                    <li class="infor_txt">报名描述：&nbsp;<font style="color: red"></font></li>
                    <li>
                        <div class="infot_input">
            ...
            <div class="add_infor" style="margin-top: 245px; height: 650px;">
                <ul>
                    <li class="infor_txt">活动内容：&nbsp;<font style="color: red">*</font></li>
                    <li>
            ...
            <div class="add_infor">
                <ul>
                    <li class="infor_txt">活动状态：&nbsp;<font style="color: red"></font></li>
                    <li>
                        <div class="c12">
