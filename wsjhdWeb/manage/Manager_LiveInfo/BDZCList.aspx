<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDZCList.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDZCList" %>
    ...
    <div class="itempage">
        <div class="search_total" style="height: 140px">
            ...
            <div class="itme_input">
                ...
                <a class="add_user1" href="BDZCAdd.aspx?typid=<%=typid %>" style="cursor: pointer">添加租车信息</a>
                <br class="clear_both" />
            </div>
            <div class="btnall">
            </div>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="width: 20%">
                                    <a href="BDZCAdd.aspx?id=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit&typid=<%=typid %>"
                                        style="color: black;">编辑</a> <a style="color: red;" href="BDZCList.aspx?del=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>"
