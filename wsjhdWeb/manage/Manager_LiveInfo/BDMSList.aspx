<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDMSList.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDMSList" %>
    ...
    <div class="itempage">
        <div class="search_total" style="height: 140px">
            ...
            <div class="itme_input">
                ...
                <a class="add_user1" href="BDMSBannerList.aspx?tid=<%=typid %>" style="cursor: pointer">查看Banner</a>
                <a class="add_user1" href="BDMSAdd.aspx?typid=<%=typid %>" style="cursor: pointer">
                    添加美食信息</a>
                <br class="clear_both" />
            </div>
            <div class="btnall">
                    ...
                    <asp:Repeater ID="rptLoop" runat="server">
                        <HeaderTemplate>
                            <tr>
                                ...
                                <th class="list_li_txt2" style="width: 8%">
                                    排序号
                                </th>
                                <th class="list_li_txt2" style="width: 12%">
                                    创建时间
                                </th>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="cursor: hand; width: 23%" alt="<%#Eval("Title")%>">
                                    <%#Eval("Title")%>
                                </td>
                                 <td class="list_li_txt3" style="width: 25%">
                                    <%#Eval("Extend1")%>
                                 </td>
                                <td class="list_li_txt3" style="width: 8%">
                                    <%#Eval("Orders") %>
                                </td>
                                <td class="list_li_txt3" style="width: 12%">
                                    <%#string.Format("{0:yyyy-MM-dd}",Eval("AddTime"))%>
                                </td>
                                <td class="list_li_txt3" style="width: 20%">
                                    <a href="BDMSAdd.aspx?id=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit&typid=<%=typid %>"
                                        style="color: black;">编辑</a> <a style="color: red;" href="BDMSList.aspx?del=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>"
