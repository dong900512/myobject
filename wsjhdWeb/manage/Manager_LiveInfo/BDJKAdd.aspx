<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDJKAdd.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDJKAdd"
...
<head>
    ...
    <script>
        ...
        function checkedJS() {
            ...
            var tdesc = $("#txtsummary").val();
            var lx = $("#txtkeyword").val();
            var reg_num = /^[-+]?\d+$/;
        ...
        <div>
            ...
            <div class="add_infor">
                <ul>
                    ...
                    <li>
                        <div class="infot_input">
                            <asp:TextBox ID="txtkeyword" runat="server" CssClass="input_txt" MaxLength="50"></asp:TextBox><font
                                color="red"></font></div>
                    </li>
            ...
            <div class="add_infor" id="slt" runat="server" visible="false" style="padding-bottom: 130px;">
                <ul>
                    ...
                    <li>
                        <img src="<%=curimg %>" style="width: 50%;" />
                    </li>
                </ul>
            </div>
            <div class="add_infor" style="">
                <ul>
                    ...
                    <li>
                        <div class="infot_input">
                            <input id="upfile" runat="server" onchange="return confirmsuffix(this)" type="file" /><font
                                color="red"><asp:HyperLink runat="server" ID="hyp" Visible=false  Target="_blank"/>(600*300)
                    </font></div>
                    </li>
                </ul>
            </div>
            <div class="add_infor">
                <ul>
                    <li class="infor_txt">描述：&nbsp;<font style="color: red"></font></li>
                    <li>
                        <div class="infot_input">
            ...
            <div class="add_infor" style="margin-top: 245px; height: 450px;">
                <ul>
                    <li class="infor_txt">详情：&nbsp;<font style="color: red">*</font></li>
                    <li>
