<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiveInfoBMList.aspx.cs"
    Inherits="NewInfoWeb.manage.Manager_LiveInfo.LiveInfoBMList" %>

<!DOCTYPE html >
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>当前活动报名信息</title>
    ...
    <div class="itempage">
        <div class="search_total" style="height: 140px">
            ...
            <div class="itme_input">
                活动名称：<%=str%>
                <a class="add_user" href="LiveInfoList.aspx" style="cursor: pointer">返回活动</a>
                <br class="clear_both" />
            </div>
            <div class="btnall">
                    ...
                    <asp:Repeater ID="rptLoop" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="cursor: hand; width: 10%" alt="<%#Eval("Title")%>">
                                    <%#Eval("Name")%>
                                </td>
                                ...
                                <td class="list_li_txt3" style="width: 10%">
                                    <a style="color: red;" href="LiveInfoBMList.aspx?del=<%#Eval("Id") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>"
