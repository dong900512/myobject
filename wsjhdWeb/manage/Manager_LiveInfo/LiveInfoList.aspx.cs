...
{
    public partial class LiveInfoList : ManageBasePage
    {
        ...
        private void BindRepeater()
        {
            ...
            using (WXDBEntities db = new WXDBEntities())
            {
                IQueryable<Article> carlist = db.Article.Where(s => (!s.Status.Equals(2)) &&s.Type.Equals(0)).OrderBy(o => o.Orders).ThenByDescending(o => o.AritcleID);
