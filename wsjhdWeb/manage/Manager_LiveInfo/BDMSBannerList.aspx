<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDMSBannerList.aspx.cs"
    Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDMSBannerList" %>

<!DOCTYPE html >
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>美食Banner列表</title>
    ...
    <div class="itempage">
        <div class="search_total" style="height: 140px">
            ...
            <div class="itme_input">
                ...
                <a class="add_user" href="BDMSBannerAdd.aspx?typid=<%=typid %>" style="cursor: pointer">
                    添加信息</a>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="width: 20%">
                                    <a href="BDMSBannerAdd.aspx?id=<%#Eval("RId") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit&typid=<%=typid %>"
