<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDYWList.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDYWList" %>

<!DOCTYPE html >
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>半岛游玩项目列表</title>
    ...
    <div class="itempage">
        <div class="search_total" style="height: 140px">
            ...
            <div class="itme_input">
                ...
                <a class="add_user1" href="BDYWAdd.aspx?typid=<%=typid %>" style="cursor: pointer">添加游玩项目</a>
                <a class="add_user1" href="BDYWTypeList.aspx" style="cursor: pointer">返回项目类型</a>
                <br class="clear_both" />
            </div>
            <div class="btnall">
            </div>
                    ...
                    <asp:Repeater ID="rptLoop" runat="server">
                        <HeaderTemplate>
                            <tr>
                                ...
                                <th class="list_li_txt2" style="width: 30%">
                                    名称
                                </th>
                                <th class="list_li_txt2" style="width: 32%">
                                    描述
                                </th>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="cursor: hand; width: 30%" title="<%#Eval("Title")%>">
                                    <%#Eval("Title")%>
                                </td>
                                <td class="list_li_txt3" style="width: 32%" title="<%#Eval("Description") %>">
                                    <%#Eval("Description") %>
                                </td>
                                <td class="list_li_txt3" style="width: 26%">
                                    <a href="BDYWAdd.aspx?id=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit&typid=<%=typid %>"
                                        style="color: black;">编辑</a> <a style="color: red;" href="BDYWList.aspx?del=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>"
                ...
                <ul>
                    <li class="list_li_page"><span style="float: left; margin-top: 20px; display: none;">
                        ...
                        <webdiyer:AspNetPager ID="AspNetPager1" ShowCustomInfoSection="Left" Visible="true"
                            ...
                            ShowInputBox="Always" ShowBoxThreshold="10" PageSize="1" CssClass="pagination"
