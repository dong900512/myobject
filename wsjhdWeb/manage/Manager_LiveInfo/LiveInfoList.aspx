<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiveInfoList.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.LiveInfoList" %>
    ...
    <div class="itempage">
        <div class="search_total" style="height: 140px">
            ...
            <div class="itme_input">
                ...
                <a class="add_user1" href="ActivityBannerList.aspx" style="cursor: pointer">查看滚动Banner</a>
                <a class="add_user" href="LiveInfoAdd.aspx" style="cursor: pointer">添加活动</a>
                <br class="clear_both" />
            </div>
            <div class="btnall">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="width: 26%">
                                    <a href="LiveInfoAdd.aspx?id=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit"
                                        style="color: black;">编辑</a> <a style="color: red;" href="CTListInfo.aspx?del=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>"
                                            onclick="return confirm('删除后将无法恢复，您确定要删除吗？');">删除</a><a href="LiveInfoBMList.aspx?tid=<%#Eval("AritcleID") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>">查看报名详情</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
