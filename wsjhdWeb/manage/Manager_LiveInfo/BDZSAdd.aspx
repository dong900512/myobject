<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BDZSAdd.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BDZSAdd"
                    ...
                    <li>
                        <div class="infot_input">
                            <input id="upfile" runat="server" onchange="return confirmsuffix(this)" type="file" /><font
                                color="red"><asp:HyperLink runat="server" ID="hyp" Visible=false  Target="_blank"/>(200*150)
                    </font></div>
                    </li>
                </ul>
            </div>
