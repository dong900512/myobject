<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BannerList.aspx.cs" Inherits="NewInfoWeb.manage.Manager_LiveInfo.BannerList" %>
    ...
    <div class="itempage">
        <div class="search_total" style="height: 140px">
            ...
            <div class="itme_input">
                ...
                <a class="add_user" href="BannerAdd.aspx?typid=<%=stypid %>" style="cursor: pointer">
                    添加信息</a>
                <br class="clear_both" />
            </div>
            <div class="btnall">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="width: 20%">
                                    <a href="BannerAdd.aspx?id=<%#Eval("RId") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit&typid=<%=stypid %>"
                                        style="color: black;">编辑</a> <a style="color: red;" href="BannerList.aspx?del=<%#Eval("RId") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>"
