<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="keyword.aspx.cs" Inherits="NewInfoWeb.manage.Manager_Info.keyword" %>
...
<head id="Head1" runat="server">
    ...
    <style>
        ...
        .list_item_txt td { height: auto; float: inherit; }
        .list_item_txt th { height: auto; float: inherit; }
    ...
    <div class="itempage">
        <div class="search_total" style="height: 140px">
            ...
            <div class="itme_input">
                ...
                <a class="add_user1" href="keywordAdd.aspx" style="cursor: pointer">添加关键词回复</a>
                <br class="clear_both" />
            </div>
            <div class="btnall">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="cursor: hand; width: 20%">
                                    <div class='<%#string.IsNullOrEmpty(Eval("Cover")+"")?"hid":"" %>'>
                                        <img src="/files/NewsImg/<%#Eval("Cover") %>" style="width: 60%;" />
                                    </div>
                                </td>
                                ...
                                <td title='<%#Eval("Description")%>' class="list_li_txt3" style="width: 20%">
                                    <%#Eval("Description")%>
                                </td>
                                <td class="list_li_txt3" style="width: 23%">
                                    <a href="keywordAdd.aspx?id=<%#Eval("Id") %>&page=<%#AspNetPager1.CurrentPageIndex %>&change=edit"
                                        style="color: black;">编辑</a> <a style="color: red;" href="keyword.aspx?del=<%#Eval("Id") %>&page=<%#AspNetPager1.CurrentPageIndex %>&key=<%#Request["key"] %>"
