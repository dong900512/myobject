...
{
    public partial class WYNoticeList : System.Web.UI.Page
    {
        ...
        private void BindRepeater()
        {
            ...
            using (WXDBEntities db = new WXDBEntities())
            {
                IQueryable<Article> carlist = db.Article.Where(s => (!s.Status.Equals(2)) && s.Type.Equals(26)).OrderBy(o => o.Orders).ThenByDescending(o => o.AddTime);
