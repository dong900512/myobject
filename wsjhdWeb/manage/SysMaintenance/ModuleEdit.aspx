<%@ Page Title="" Language="C#" MasterPageFile="~/manage/SysMaintenance/maintenancemaster.master"
    AutoEventWireup="true" CodeBehind="ModuleEdit.aspx.cs" Inherits="NewInfoWeb.manage.SysMaintenance.ModuleEdit" %>
    ...
    <table class="table" cellpadding="4" cellspacing="1">
        <tbody>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtModuleName" runat="server" Width="418px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDefaultUrl" runat="server" Width="418px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="htd" valign="top">
                ...
                <td>
                    <asp:FileUpload ID="upPicPath" runat="server" Width="415px" />
                </td>
            </tr>
            <tr class="tr1">
                <td>
