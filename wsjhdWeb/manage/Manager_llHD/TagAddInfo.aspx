<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TagAddInfo.aspx.cs" Inherits="NewInfoWeb.manage.Manager_llHD.TagAddInfo" %>
...
<body>
    ...
    <div class="add_border">
        ...
        <div>
            ...
            <div class="add_infor">
                <ul>
                    <li class="infor_txt">标签名称：&nbsp;<font style="color: red">*</font></li>
                    <li>
                        <div class="infot_input">
