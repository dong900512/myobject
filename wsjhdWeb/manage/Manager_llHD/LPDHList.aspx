<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LPDHList.aspx.cs" Inherits="NewInfoWeb.manage.Manager_llHD.LPDHList" %>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="list_li_txt3" style="width: 26%">
                                    <a style="color: red;" href="LPDHList.aspx?del=<%#Eval("Id") %>&topid=<%=cod %>" onclick="return confirm('删除后将无法恢复，您确定要删除吗？');">
                                        删除</a> <a style="color: Red;" class='<%#Eval("Status").ToString()=="0"?"":"hd1" %>'
                                            onclick="return confirm('是否已经领取？');" href="LPDHList.aspx?upd=<%#Eval("Id") %>&topid=<%=cod %>">未领取</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
