...
{
    public partial class HdInfoList : System.Web.UI.Page
    {
        ...
        private void BindRepeater()
        {
            ...
            using (WXDBEntities db = new WXDBEntities())
            {
                IQueryable<Forms> carlist = db.Forms.Where(s => s.Type.Equals(2)).OrderBy(o => o.Orders).ThenByDescending(o => o.AddTime);
