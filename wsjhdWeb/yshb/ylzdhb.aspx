<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ylzdhb.aspx.cs" Inherits="NewInfoWeb.yshb.ylzdhb" %>

<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>英伦尊邸新年签到 来领红包</title>
    ...
    <style>
        ...
        .pg1_5 { position: absolute; bottom: 0; width: 100%; height: auto !important;left: 0; }
    ...
    <style>
        .pgiinfo { width: 30% !important; margin-left: 35%; height: auto !important; }
        .std { -webkit-animation: tada 1s linear 3 both; }
    </style>
</head>
<body>
    <div class="spinner">
    ...
    <div class="main">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img class="divBg" src="img/zd/2.jpg" />
                    <img class="pg1_1 ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s"
                        swiper-animate-delay="0.6s" src="img/zd/2.1.png" width="100%" />
                    <img class="pg1_1 ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s"
                        swiper-animate-delay="0.9s" src="img/zd/2.2.png" width="100%" />
                    <img class="pg1_1 ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s"
                        swiper-animate-delay="1.4s" src="img/zd/2.3.png" width="100%" />
                    <img class="pg1_1 ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s"
                        swiper-animate-delay="1.7s" src="img/zd/2.4.png" width="100%" />
                    <img class="arrows-up ani infinite" swiper-animate-effect="arrowsSlide" swiper-animate-duration="1s"
                        swiper-animate-delay="s" src="/Tepay/img/arrow-up.png" style="width: 40px!important;
                        height: 30px!important;" />
                </div>
                <div class="swiper-slide">
                    <img class="divBg" src="img/zd/3.jpg" />
                    <img class="pg1_1 ani" swiper-animate-effect="fadeInDown" swiper-animate-duration="0.3s"
                        swiper-animate-delay="0.3s" src="img/zd/3.1.png" width="100%" />
                    <img class="pg1_1 ani" swiper-animate-effect="fadeIn" swiper-animate-duration="0.6s"
                        swiper-animate-delay="0.9s" src="img/zd/3.2.png" width="100%" />
                    <img class="pg1_1 ani" swiper-animate-effect="fadeIn" swiper-animate-duration="0.6s"
                        swiper-animate-delay="1.2s" src="img/zd/3.3.png" width="100%" />
                    <img class="pg1_1 ani pgiinfo" swiper-animate-effect="zoomIn" swiper-animate-duration="0.6s"
                        swiper-animate-delay="1.5s" src="img/zd/btn.png" />
                    <img class="arrows-up ani infinite" swiper-animate-effect="arrowsSlide" swiper-animate-duration="1s"
                        swiper-animate-delay="s" src="/Tepay/img/arrow-up.png" style="width: 40px!important;
                        height: 30px!important;" />
                </div>
                <div class="swiper-slide">
                    <img class="divBg" src="img/zd/4.jpg" />
                    <img class="pg1_1 ani" swiper-animate-effect="fadeInDown" swiper-animate-duration="0.3s"
                        swiper-animate-delay="0.3s" src="img/zd/4.1.png" width="100%" />
                    <img class="pg1_1 ani pst" swiper-animate-effect="fadeIn" swiper-animate-duration="0.6s"
                        swiper-animate-delay="0.9s" src="img/zd/4.2.png" width="100%" />
                    <img class="pg1_1 ani" swiper-animate-effect="fadeIn" swiper-animate-duration="0.6s"
                        swiper-animate-delay="1.2s" src="img/zd/4.3.png" width="100%" />
                    <img class="pg1_1 ani " swiper-animate-effect="fadeIn" swiper-animate-duration="0.6s"
                        swiper-animate-delay="1.5s" src="img/zd/4.4.png" width="100%" />
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        dataForWeixin.url = "http://wsjhb.tencenthouse.com/yshb/ylzdhb.aspx";
        dataForWeixin.desc = "英伦尊邸新年签到";
        dataForWeixin.title = "英伦尊邸新年签到";
                ...
                var mySwiper = new Swiper('.swiper-container', {
                    ...
                    onSlideChangeEnd: function (swiper) {
                        ...
                        if (mySwiper.activeIndex == 2) {
                            $(".pgiinfo").css("margin-top", vh * 660 / 1008);
                            $(".pgiinfo").on("touchend", function (e) {
                                window.location.href = "http://woishiplngland.tencenthouse.com/jjrinfo/index.htm";
                            });
                        }
                        if (mySwiper.activeIndex == 3) {
                            ...
                            Shake.Init(function () {
                                $(".pst").removeClass("fadeIn animated").addClass("std");
                                setTimeout(function () {
                                    if ("<%=isexit %>" == "0" || "<%=iscj %>" == "0") {
                            ...
                            $(".pst").removeClass("std").addClass("fadeIn animated");
                        }
                    }
                });
