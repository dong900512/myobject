<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BRInfo.aspx.cs" Inherits="NewInfoWeb.yqh.BRInfo" %>
...
@-webkit-keyframes zoomInUp {
  ...
  60% {
    ...
    -webkit-animation-timing-function: cubic-bezier(0.175, 0.885, 0.320, 1);animation-timing-function: cubic-bezier(0.175, 0.885, 0.320, 1);}100%{opacity:1;}}
        ...
        .sec1{background:url(img4/1.jpg); background-size:100% 100%; width:100%; height:100%;}
        .sec2{background:url(img2/bg.png); background-size:100% 100%; width:100%; height:100%;display:none;position: absolute;top: 0;z-index: 10; }
        
        .sec3{background:url(img2/2.jpg); background-size:100% 100%; width:100%; height:100%;display:none;}
        .sec4{background:url(img4/3.png); background-size:100% 100%; width:100%; height:100%;display:none;position:absolute;top: 0;left: 0;z-index: 10;}
        .sec5{ width:100%; height:100%;display:none;position:absolute; z-index:10; top:0;background-color: rgba(0,0,0,.4); z-index:10}
        .sec6{background-size:100% 100%; width:100%; height:100%;display:none;position:absolute; z-index:10; top:0;background-color: rgba(0,0,0,.4);}
        .sec7{background:url(img2/fx.png); background-size:100% 100%; width:100%; height:100%;display:none; position:absolute; z-index:10; top:0;}
        .sec1_1{opacity:0;width:100%; height:100%;position:absolute; background:url(img4/1.1.png); background-size:100% 100%;-webkit-animation:bounceInDown 1s .3s both; z-index:1;}
        .sec1_2{opacity:0; width: 100%;height: 100%; position:absolute; background:url(img4/1.2.png); background-size:100% 100%; z-index:1;-webkit-animation: show1 1s  .6s linear infinite both;z-index:1;}
        .sec1_3{opacity:0;width:100%; height:100%;position:absolute; background:url(img4/1.6.png); background-size:100% 100%;-webkit-animation:zoomInUp 1s .9s both;z-index:2;}
        .sec1_4{opacity:0; width: 100%;height: 100%; position:absolute; background:url(img4/1.3.png); background-size:100% 100%; z-index:1;-webkit-animation: show1 1s  1.2s linear  alternate  infinite both;z-index:3;}
        .sec1_5{opacity:0; width: 100%;height: 100%; position:absolute; background:url(img4/1.4.png); background-size:100% 100%; z-index:1;-webkit-animation: show1 1s  1.6s linear  alternate  infinite both;z-index:3;}
        .sec1_6{opacity:0; width: 100%;height: 100%; position:absolute; background:url(img4/1.5.png); background-size:100% 100%; z-index:1;-webkit-animation: show1 1s  2s linear  alternate  infinite both;z-index:3;}
        .sec1_7{opacity:0; width:100%; height:100%;position:absolute; background:url(img4/1.7.png); background-size:100% 100%; -webkit-animation: zoomInUp 1s  1.3s linear  forwards; z-index:3;}
        .sec1_8{opacity:0; width:100%; height:100%;position:absolute; background:url(img4/1.8.png); background-size:100% 100%; -webkit-animation: show1 1s  1.8s linear both; z-index:3;}
        ...
        .it6{opacity:0;width:100%; height:100%;position:absolute; background:url(img4/gz.jpg); background-size:100% 100%; -webkit-animation: show1 1s .5s linear  forwards;}
         .not{ z-index:10; margin-left:157px; width:320px; height:95px; position:absolute; background:url(img4/not.png);background-size:100% 100%;-webkit-animation: show1 1s  1.8s linear both; bottom:19%; border:0px;}
         .yes{z-index:10; margin-left:157px; width:318px; height:95px; position:absolute; background:url(img4/yes.png);background-size:100% 100%;-webkit-animation: show1 1s  1.8s linear both;bottom:31%; border:0px;}
         ...
         .it12{opacity:0; border:0; margin-left:114px; width:399px; height:98px; position:absolute; background:url(img4/btnsure.png); background-size:100% 100%; -webkit-animation: show1 1.5s 1.5s linear forwards;z-index:15;bottom: 11%;}
         
         .id5{opacity:0; width:100%; height:100%;position:absolute; background:url(img4/5.jpg); background-size:100% 100%; -webkit-animation: bounceInDown1 2s  .5s linear  forwards;}
                 
        .id6{opacity:0; width:100%; height:100%;position:absolute; background:url(img4/6.jpg); background-size:100% 100%; -webkit-animation: bounceInDown1 2s  .5s linear  forwards;}                 
         ::-webkit-input-placeholder{ color:#e73357;}
         input{ width:373px; height:80px; line-height:80px; position:absolute; background-color:white; color:#e73357; font-size:2.5em; margin-left:108px; font-weight:bold; padding-left:57px;border:1px solid #6a3906; border-radius:22px;}
         .tname{}
         .tphone{}
         .btnsure{ border:0; margin-left:114px; width:399px; height:98px; position:absolute; background:url(img4/btnsure.png); background-size:100% 100%;z-index:15;}
...
<body>
    ...
    <script type="text/javascript">
        dataForWeixin.title = "碧然之家";
        dataForWeixin.desc = "碧然之家";
        dataForWeixin.img = "http://wsjhb.tencenthouse.com/yqh/img4/fxs.jpg";
        ...
        var sourceArr = ['img1/4.mp3', 'img4/1.jpg', 'img4/1.1.png', 'img4/1.2.png', 'img4/1.3.png', 'img4/1.4.png', 'img4/1.5.png', 'img4/1.6.png', 'img4/1.7.png', 'img4/1.8.png', 'img4/3.png', 'img4/btnsure.png', 'img2/fx.png', 'img4/gz.jpg', 'img4/not.png', 'img4/yes.png', 'img4/5.jpg', 'img4/6.jpg']; //需要加载的资源列表
        new mo.Loader(sourceArr, {
            ...
            onComplete: function (time) {
                ...
                $(".btnsure").on("click", function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/yqh/helper4.ashx?type=AddInfo',
                        dataType: 'json',
                        data: {
