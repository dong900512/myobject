<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lxkjcinfo.aspx.cs" Inherits="NewInfoWeb.yqh.lxkjcinfo" %>

<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>诸暨联想科技城，喜迎八方来客</title>
...
@-webkit-keyframes zoomInUp {
  ...
  60% {
    ...
    -webkit-animation-timing-function: cubic-bezier(0.175, 0.885, 0.320, 1);animation-timing-function: cubic-bezier(0.175, 0.885, 0.320, 1);}100%{opacity:1;}}
        ...
        .sec1{background:url(img3/1.jpg); background-size:100% 100%; width:100%; height:100%;}
        ...
        .sec4{background:url(img3/3.png); background-size:100% 100%; width:100%; height:100%;display:none;position:absolute;top: 0;left: 0;z-index: 10;}
        ...
        .sec1_1{opacity:0;width:100%; height:100%;position:absolute; background:url(img3/1.4.png); background-size:100% 100%;-webkit-animation:zoomInUp 1s .3s both; z-index:1;}
        .sec1_2{opacity:0; width: 100%;height: 100%; position:absolute; background:url(img3/1.6.png); background-size:100% 100%; z-index:1;-webkit-animation: show1 1s  .6s linear both;z-index:1;}
        .sec1_3{opacity:0;width:100%; height:100%;position:absolute; background:url(img3/1.5.png); background-size:100% 100%;-webkit-animation:zoomInUp 1s .9s both;z-index:2;}
        .sec1_4{opacity:0; width: 100%;height: 100%; position:absolute; background:url(img3/1.1.png); background-size:100% 100%; z-index:1;-webkit-animation: show1 1s  1.2s linear  alternate  infinite both;z-index:3;}
        .sec1_5{opacity:0; width: 100%;height: 100%; position:absolute; background:url(img3/1.2.png); background-size:100% 100%; z-index:1;-webkit-animation: show1 1s  1.6s linear  alternate  infinite both;z-index:3;}
        .sec1_6{opacity:0; width: 100%;height: 100%; position:absolute; background:url(img3/1.3.png); background-size:100% 100%; z-index:1;-webkit-animation: show1 1s  2s linear  alternate  infinite both;z-index:3;}
        .sec1_7{opacity:0; width:100%; height:100%;position:absolute; background:url(img3/1.7.png); background-size:100% 100%; -webkit-animation: zoomInUp 1s  1.3s linear  forwards; z-index:3;}
        .sec1_8{opacity:0; width:100%; height:100%;position:absolute; background:url(img3/1.8.png); background-size:100% 100%; -webkit-animation: show1 1s  1.8s linear both; z-index:3;}
        ...
        .it6{opacity:0;width:100%; height:100%;position:absolute; background:url(img3/gz.png); background-size:100% 100%; -webkit-animation: show1 1s .5s linear  forwards;}
         .not{ z-index:10; margin-left:157px; width:317px; height:86px; position:absolute; background:url(img3/not.png);background-size:100% 100%;-webkit-animation: show1 1s  1.8s linear both; bottom:13%; border:0px;}
         .yes{z-index:10; margin-left:157px; width:317px; height:86px; position:absolute; background:url(img3/yes.png);background-size:100% 100%;-webkit-animation: show1 1s  1.8s linear both;bottom:23%; border:0px;}
         ...
         .it12{opacity:0; border:0; margin-left:114px; width:399px; height:98px; position:absolute; background:url(img3/btnsure.png); background-size:100% 100%; -webkit-animation: show1 1.5s 1.5s linear forwards;z-index:15;bottom: 11%;}
         
         .id5{opacity:0; width:100%; height:100%;position:absolute; background:url(img3/5.1.png); background-size:100% 100%; -webkit-animation: bounceInDown1 2s  .5s linear  forwards;}
                 
        .id6{opacity:0; width:100%; height:100%;position:absolute; background:url(img3/6.1.png); background-size:100% 100%; -webkit-animation: bounceInDown1 2s  .5s linear  forwards;}                 
         ...
         .tname{}
         .tphone{}
         .btnsure{ border:0; margin-left:114px; width:399px; height:98px; position:absolute; background:url(img3/btnsure.png); background-size:100% 100%;z-index:15;}
...
<body>
    ...
    <script type="text/javascript">
        dataForWeixin.title = "诸暨联想科技城，喜迎八方来客";
        dataForWeixin.desc = "诸暨联想科技城，喜迎八方来客";
        ...
        var sourceArr = ['img1/4.mp3', 'img3/1.jpg', 'img3/1.1.png', 'img3/1.2.png', 'img3/1.3.png', 'img3/1.4.png', 'img3/1.5.png', 'img3/1.6.png', 'img3/1.7.png', 'img3/1.8.png', 'img3/3.png', 'img3/btnsure.png', 'img2/fx.png', 'img3/gz.png', 'img3/not.png', 'img3/yes.png', 'img3/5.1.png', 'img3/6.1.png']; //需要加载的资源列表
        new mo.Loader(sourceArr, {
            ...
            onComplete: function (time) {
                ...
                $(".btnsure").on("click", function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/yqh/helper3.ashx?type=AddInfo',
                        dataType: 'json',
                        data: {
