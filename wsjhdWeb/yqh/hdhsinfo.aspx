<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hdhsinfo.aspx.cs" Inherits="NewInfoWeb.yqh.hdhsinfo" %>

<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>认筹火爆 普天同庆</title>
...
@-webkit-keyframes zoomInUp {
  ...
  60% {
    ...
    -webkit-animation-timing-function: cubic-bezier(0.175, 0.885, 0.320, 1);animation-timing-function: cubic-bezier(0.175, 0.885, 0.320, 1);}100%{opacity:1;}}
        ...
        .sec1{background:url(img1/1.jpg); background-size:100% 100%; width:100%; height:100%;}
        .sec2{background:url(img1/bg.png); background-size:100% 100%; width:100%; height:100%;display:none;position: absolute;top: 0;z-index: 100; }
        
        .sec3{background:url(img1/2.jpg); background-size:100% 100%; width:100%; height:100%;display:none;}
        .sec4{background:url(img1/3.jpg); background-size:100% 100%; width:100%; height:100%;display:none;}
        .sec5{background:url(img1/bg.jpg); background-size:100% 100%; width:100%; height:100%;display:none;}
        .sec6{background:url(img1/bg.jpg); background-size:100% 100%; width:100%; height:100%;display:none;}
        .sec7{background:url(img1/fx.png); background-size:100% 100%; width:100%; height:100%;display:none; position:absolute; z-index:100; top:0;}
        ...
        .x1{opacity:0;width:100%; height:100%;position:absolute; background:url(img1/1.2.png); background-size:100% 100%;-webkit-animation: show1 1.5s  .5s linear infinite  forwards;}
        .x2{opacity:0;width:100%; height:100%;position:absolute; background:url(img1/1.2.png); background-size:100% 100%;-webkit-animation:zoomInUp 1s 1s both;}
        .x3{opacity:0;width:100%; height:100%;position:absolute; background:url(img1/1.3.png); background-size:100% 100%;-webkit-animation:zoomInUp 1s 1.5s forwards;}
        .x4{opacity:0;width:100%; height:100%;position:absolute; background:url(img1/1.4.png); background-size:100% 100%;-webkit-animation:zoomInUp 1s 2s forwards;}
        
        .x5{opacity:0;width:100%; height:100%;position:absolute; background:url(img1/1.5.png); background-size:100% 100%;-webkit-animation:zoomInUp 1s 2.5s forwards;}
        ...
        .it6{opacity:0;width:100%; height:100%;position:absolute; background:url(img1/gz.png); background-size:100% 100%; -webkit-animation: show1 1s .5s linear  forwards;}
         .not{ z-index:10; margin-left:187px; width:271px; height:68px; position:absolute; background:url(img1/not.png);background-size:100% 100%;-webkit-animation: show1 1s  3s linear both; bottom:22%; border:0px;}
         .yes{z-index:10; margin-left:187px; width:271px; height:94px; position:absolute; background:url(img1/yes.png);background-size:100% 100%;-webkit-animation: show1 1s  3s linear both;bottom:30%; border:0px;}
         ...
         .it12{opacity:0; border:0; margin-left:205px; width:216px; height:89px; position:absolute; background:url(img1/btnsure.png); background-size:100% 100%; -webkit-animation: show1 1.5s 1.5s linear forwards;z-index:15;bottom: 11%;}
         
         .id5{opacity:0; width:100%; height:100%;position:absolute; background:url(img1/5.1.png); background-size:100% 100%; -webkit-animation: bounceInDown1 2s  .5s linear  forwards;}
                 
        .id6{opacity:0; width:100%; height:100%;position:absolute; background:url(img1/6.1.png); background-size:100% 100%; -webkit-animation: bounceInDown1 2s  .5s linear  forwards;}                 
         ::-webkit-input-placeholder{ color:#e73357;}
         input{ width:431px; height:80px; line-height:80px; position:absolute; background-color:white; color:#e73357; font-size:2.5em; margin-left:70px; font-weight:bold; padding-left:57px;border:1px solid #6a3906; border-radius:54px;}
         .tname{}
         .tphone{}
         .btnsure{ border:0; margin-left:141px; width:352px; height:113px; position:absolute; background:url(img1/btnsure.png); background-size:100% 100%;z-index:15;}
...
<body>
    ...
    <script type="text/javascript">
        dataForWeixin.title = "认筹火爆 普天同庆";
        dataForWeixin.desc = "开门红送红包";
        dataForWeixin.img = "http://wsjhb.tencenthouse.com/yqh/img1/fxs.jpg";
        var count = 0;
        ...
        new mo.Loader(sourceArr, {
            ...
            onComplete: function (time) {
                ...
                $(".btnsure").on("click", function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/yqh/helper1.ashx?type=AddInfo',
                        dataType: 'json',
                        data: {
