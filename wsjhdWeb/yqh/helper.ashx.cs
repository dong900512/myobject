    ...
    public class helper : IHttpHandler, IRequiresSessionState
    {
        ...
        private void AddWSJInfo(HttpContext context)
        {
            try
            {
                ...
                {
                    if (context.Request.Cookies["WSJWebDomain"] == null || string.IsNullOrEmpty(context.Request.Cookies["WSJWebDomain"]["useropid"]))
                    {
                    ...
                    else
                    {
                        ...
                        using (WXDBEntities db = new WXDBEntities())
                        {
                            ...
                            var modelt = db.Forms.Where(s => s.Name.Equals(tname)).FirstOrDefault();
                            ...
                            {
                                var tmpopid = context.Request.Cookies["WSJWebDomain"]["useropid"];
