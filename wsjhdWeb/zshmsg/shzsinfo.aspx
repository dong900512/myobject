<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shzsinfo.aspx.cs" Inherits="NewInfoWeb.zshmsg.shzsinfo" %>
...
<head>
    ...
    <style>
           ...
           @-webkit-keyframes st3{0%{-webkit-transform:translate3d(0,0, 0);opacity:1;}100%{-webkit-transform:translate3d(0,-16%, 0);opacity:1;}}
            ...
            @-webkit-keyframes fbg{0%{background: url(img/hf/2.3.png);background-size:100% 100%;}20%{background: url(img/hf/2.4.png);background-size:100% 100%;}40%{background: url(img/hf/2.5.png);background-size:100% 100%;}60%{}80%{background: url(img/hf/2.6.png);background-size:100% 100%;}100%{background: url(img/hf/2.7.png);background-size:100% 100%;}}
           @-webkit-keyframes rotate1{0%{-webkit-transform:rotate(0)}25%{-webkit-transform:rotate(15deg)}50%{-webkit-transform:rotate(0)}75%{-webkit-transform:rotate(-15deg)}100%{-webkit-transform:rotate(0)}}
        ...
        input { width: 85%;  height: 25px; line-height: 25px;  left: 0; background-color: white; color: black; font-size: 1.1rem; font-weight: bold; padding-left: 20px; border: 1px solid #6a3906; border-radius: 13px; }
        ...
        .box1_info{position: relative; display: inline-block; text-align: left; pointer-events: auto;}
        ::-webkit-input-placeholder{ color:white;}
        input { width: 85%;  height: 35px; line-height: 30px;  left: 0; background-color: white; color: black; font-size: 1.1rem; font-weight: bold; padding-left: 20px; border: 1px solid #6a3906; border-radius: 13px; }
        .tname { margin-top: 2px; }
        .sex { margin-top: 10px; }
        .tphone { margin-top: 2px; }
        ...
        #markTips{ background:url(img/tips1.png) no-repeat center top; position:fixed; top:0px; left:0px; width:100%; height:100%; z-index:333; display:none; background-size:100% 100%;}
       ...
       .s3{display:none; position:relative; top:0; left:0; background:url(img/8.jpg); background-size:100% 100%;}
       ...
       .zjxq{width: 90%; height: 37%;left: 5%;position: absolute;text-align: center;background-color: rgba(255,255,255,.6);bottom: 6%;border-radius: 4%; -webkit-box-sizing : border-box; overflow:hidden; background:url(img/zmbj.png); background-size:100% 100%;}
        .itmlist { width: 80%;    position: absolute;z-index:10%;left: 10%;height: 65%; font: 12px/1.5 tahoma, '\5b8b\4f53' ,sans-serif; overflow-y:auto; -webkit-overflow-scrolling: touch;}
...
(/\D+/g, "")' onblur='this.value = this.value.replace(/\D+/g, "")' /><br />
                        <div style="text-align: left; margin-left: 8%; margin-top: 10px;">
                            联系地址：</div>
                        <input type="text" class="taddress" /><br />
    ...
    <script type="text/javascript">
        ...
        var rtim1;
        $(function () {
            var sourceArr = ['img/1.1.png', 'img/1.2.png', 'img/1.3.png', 'img/1.4.png', 'img/1.5.png', 'img/1.jpg', 'img/2.jpg', 'img/3.jpg', 'img/4.jpg', 'img/5.jpg', 'img/2.1.png', 'img/3.1.png', 'img/3.2.png', 'img/3.3.png', 'img/4.1.png', 'img/5.1.png', 'img/5.2.png', 'img/5.3.png', 'img/5.4.png', 'img/arraw.png', 'img/bj.png', 'img/bt1.png', 'img/clos1.png', 'img/6.jpg', 'img/hkbj.png', 'img/schk.png', 'img/sczp.png', 'img/7.1.png', 'img/7.2.png', 'img/7.3.png', 'img/7.jpg', 'img/ly.png', 'img/st.png', 'img/cl.png', 'img/sc.png', 'img/8.jpg', 'img/8.1.png', 'img/zjmd.png', 'img/zmbj.png', 'img/j0.jpg', 'img/j1.jpg', 'img/j2.jpg', 'img/j3.jpg', 'img/j4.jpg'];
            new mo.Loader(sourceArr, {
                onLoading: function (count, total) {
                    ...
                    if ("<%=iscurcj %>" == "1") {
                        dataForWeixin.async = true;
                        dataForWeixin.url = "http://wsjhd.tencenthouse.com/zshmsg/shzsDetail.htm?tid=<%=curtid %>";
