...
LoadingCssBlock += '.loading_per {font-size: 14px; height: 72px; width: 72px; position: absolute; color: #fff; text-align: center; left: 50%; margin: -36px 0px 0px -36px; line-height: 72px; top: 50%} .loading_ctn{background:url(/doubinfo/js/load.png);background-size:100% 100%; width:100%; height:100%;}';
