...
{
    public partial class yhdzinfo : System.Web.UI.Page
    {
        ...
        protected string GetOpid(string cd)
        {
            ...
            try
            {
                ...
                {
                    jsHint.toUrl("yhdzinfo.aspx?tid=" + curtid);
                }
                else
                {
                    opid = result.openid;
        ...
        {
            //此页面引导用户点击授权
            string strurl = OAuthApi.GetAuthorizeUrl(WebConfigurationManager.AppSettings["wxappid"], "http://wsjhb.tencenthouse.com/yhjc/yhdzinfo.aspx", tid, OAuthScope.snsapi_base);
