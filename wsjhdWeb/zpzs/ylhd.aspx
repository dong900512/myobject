<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ylhd.aspx.cs" Inherits="NewInfoWeb.zpzs.ylhd" %>

<!DOCTYPE >
<html>
<head>
    <meta charset="UTF-8">
    <title>健康小达人，光明公益行</title>
    ...
    <style>
        ...
        body { background: url(img/yl/bg.jpg) repeat-y; background-size: cover; }
        img { width: 100%; }
        #listdiv { width: 100%; }
        ...
        #applyBox { width: 80%; z-index: 802; top: 30%; left: 10%; margin: 0px; position: fixed; background-color: #197eca; border: 2px solid #197eca; border-radius: 6px; pointer-events: auto; }
        ...
        .xq { position: absolute; width: 30% !important; height: auto !important; left: 8%; }
        .px { position: absolute; width: 23% !important; height: auto !important; left: 70%; }
    </style>
</head>
<body>
...
+/g, "")'
    ...
    <div class="g1">
        ...
        <img src="img/yl/t1.jpg" />
        <img src="img/yl/t2.jpg" />
    </div>
    ...
    <div class="footinfo" style="display: none;">
        <img src="img/cy.png" style="width: 100%; display: none;" class="cy" /><img src="img/yl/gz.png" style="width: 100%;"
            class="xq" /><img src="img/yl/pm.png" style="width: 100%;" class="px" />
    </div>
    ...
    <script type="text/javascript">
        ...
        dataForWeixin.title = "健康小达人，光明公益行";
        dataForWeixin.desc = "健康小达人，光明公益行";
        dataForWeixin.img = "http://wsjhb.tencenthouse.com/zpzs/img/yl/fxs.jpg";
        var ww = $(window).width();
        var hh = $(window).height();
        var countnum = 0;
        if ($("#hid1").val() == "") {
            window.location.href = "/zpzs/ylhd.aspx";
        }
        function showMask() {
            $("#mask").css("height", "100%");
            $("#mask").show();
        ...
        window.addEventListener("load", function () {
            ...
            function changhits(pid, opid) {
                $.post("helper.ashx", { type: "HDZan1", tmpid: pid, tmpopenid: opid }, function (result) {
                    //alert(result);
                    if (result.ist == "0") {
                        ovlog('网络错误，请重试');
                        // 显示消息
            ...
            function loadinfolist(page) {
                ...
                $.post("helper.ashx", { type: "getlist2", tmppage: page, pagesize: "5" }, function (result) {
                    var listd = "";
            ...
            function loadpxinfolist(page) {
                ...
                $.post("helper.ashx", { type: "getlist3", tmppage: page, pagesize: "5" }, function (result) {
                    var listd = "";
                    var template = $(".strformat").html();
                    if (parseInt(result.count) < 1) {
                        isget = false;
